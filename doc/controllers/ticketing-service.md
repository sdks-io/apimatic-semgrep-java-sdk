...
```java
CompletableFuture<ApiResponse<ProtosOpenapiV1DeleteTicketResponse>> ticketingServiceDeleteTicketAsync(
...
ticketingServiceApi.ticketingServiceDeleteTicketAsync(deploymentId, externalTicketId).thenAccept(result -> {
...
```java
CompletableFuture<ApiResponse<ProtosOpenapiV1LinkTicketResponse>> ticketingServiceLinkTicketAsync(
    final String deploymentId,
...
ticketingServiceApi.ticketingServiceLinkTicketAsync(deploymentId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<ApiResponse<ProtosOpenapiV1UnlinkTicketResponse>> ticketingServiceUnlinkTicketAsync(
    final String deploymentId,
...
ticketingServiceApi.ticketingServiceUnlinkTicketAsync(deploymentId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<ApiResponse<ProtosOpenapiV1CreateTicketResponse>> ticketingServiceCreateTicketAsync(
...
ticketingServiceApi.ticketingServiceCreateTicketAsync(deploymentSlug, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
