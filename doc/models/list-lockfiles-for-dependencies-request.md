...
|  --- | --- | --- | --- | --- | --- |
| `Cursor` | `String` | Optional | Use cursor in response to get next page of results. | String getCursor() | setCursor(String cursor) |
...
| `RepositoryId` | `String` | Required | Repository ID to filter by. Use Projects endpoints to retrieve repository IDs. | String getRepositoryId() | setRepositoryId(String repositoryId) |
...
ListLockfilesForDependenciesRequest listLockfilesForDependenciesRequest = new ListLockfilesForDependenciesRequest.Builder(
    "deploymentId2",
    "repositoryId4"
)
.cursor("cursor6")
