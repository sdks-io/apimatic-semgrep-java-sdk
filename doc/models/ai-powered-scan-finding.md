...
|  --- | --- | --- | --- | --- | --- |
| `AiImpact` | `String` | Optional | AI-generated description of the potential impact if this vulnerability is exploited | String getAiImpact() | setAiImpact(String aiImpact) |
...
AiPoweredScanFinding aiPoweredScanFinding = new AiPoweredScanFinding.Builder()
