 ...
 */
public class SemgrepWebTokenManager extends HeaderAuth implements SemgrepWebTokenCredentials {

    /**
     * Private instance of the auth model containing the auth credentials.
     */
    private SemgrepWebTokenModel authModel;

    /**
     * Constructor.
     * @param authModel The instance of auth credentials.
     */
    public SemgrepWebTokenManager(SemgrepWebTokenModel authModel) {
    ...
    /**
     * Converts this SemgrepWebTokenManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SemgrepWebTokenManager [" + "accessToken=" + getAccessToken() + "]";
    }
    /**
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "SemgrepWebToken - " + errorMessage;
    }
