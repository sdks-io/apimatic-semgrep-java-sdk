 ...
 */
public class SemgrepJwtModel {
    private String accessToken;

    /**
     * A Constructor for SemgrepJwtModel.
     */
    private SemgrepJwtModel(String accessToken) {
    ...
    /**
     * Builds a new {@link SemgrepJwtModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link SemgrepJwtModel.Builder} object.
     */
    ...
    public static class Builder {
        ...
        /**
         * Builds the instance of SemgrepJwtModel using the provided credentials.
         * @return The instance of SemgrepJwtModel.
         */
        public SemgrepJwtModel build() {
            return new SemgrepJwtModel(accessToken);
        }
    }
}